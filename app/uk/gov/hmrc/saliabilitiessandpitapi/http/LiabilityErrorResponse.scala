...
object LiabilityErrorResponse:
  ...
  given Writes[LiabilityErrorResponse]                                   = Writes(toJson)
  given contentTypeOf: ContentTypeOf[LiabilityErrorResponse]             = ContentTypeOf(Some(ContentTypes.JSON))
  given writeable(using codec: Codec): Writeable[LiabilityErrorResponse] =
